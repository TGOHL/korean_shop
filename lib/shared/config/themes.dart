...
class AppThemes {
  ...
  static const Color bronze = Color(0xFFC8903D);

  static const Color gray = Color(0xFFA0A0A0);
  static const Color demiGrey = Color(0xFF868686);
  static const Color lightGrey = Color(0xFFF0F0F0);
  static const Color whiteLight = Color(0xFFECECEC);

  static const Color fontMain = Color(0xFF000000);
  static const Color fontSecondary = Color(0xFF616161);
